package android.support.v4.view.accessibility; class AccessibilityManagerCompat$AccessibilityManagerStubImpl { void a() { int a;
a=0;// .class Landroid/support/v4/view/accessibility/AccessibilityManagerCompat$AccessibilityManagerStubImpl;
a=0;// .super Ljava/lang/Object;
a=0;// .source "AccessibilityManagerCompat.java"
a=0;// 
a=0;// # interfaces
a=0;// .implements Landroid/support/v4/view/accessibility/AccessibilityManagerCompat$AccessibilityManagerVersionImpl;
a=0;// 
a=0;// 
a=0;// # annotations
...
a=0;//     accessFlags = 0x8
a=0;//     name = "AccessibilityManagerStubImpl"
a=0;// .end annotation
a=0;// 
a=0;// 
a=0;// # direct methods
