...
a=0;//     move-object/from16 v0, p0
a=0;// 
a=0;//     iget-boolean v2, v0, Landroid/support/v4/view/ViewPager;->mFakeDragging:Z
a=0;// 
...
a=0;// 
a=0;//     const-string v3, "No fake drag in progress. Call beginFakeDrag first."
a=0;// 
...
a=0;//     move-object/from16 v0, p0
a=0;// 
a=0;//     iget v2, v0, Landroid/support/v4/view/ViewPager;->mLastMotionX:F
a=0;// 
a=0;//     add-float v2, v2, p1
a=0;// 
a=0;//     move-object/from16 v0, p0
a=0;// 
a=0;//     iput v2, v0, Landroid/support/v4/view/ViewPager;->mLastMotionX:F
a=0;// 
a=0;//     .line 2341
a=0;//     invoke-virtual/range {p0 .. p0}, Landroid/support/v4/view/ViewPager;->getScrollX()I
a=0;// 
a=0;//     move-result v2
a=0;// 
a=0;//     int-to-float v14, v2
a=0;// 
a=0;//     .line 2342
a=0;//     .local v14, "oldScrollX":F
a=0;//     sub-float v16, v14, p1
a=0;// 
a=0;//     .line 2343
...
a=0;//     move-object/from16 v0, p0
a=0;// 
a=0;//     iget v3, v0, Landroid/support/v4/view/ViewPager;->mFirstOffset:F
a=0;// 
a=0;//     mul-float v13, v2, v3
a=0;// 
a=0;//     .line 2346
a=0;//     .local v13, "leftBound":F
a=0;//     move/from16 v0, v17
a=0;// 
a=0;//     int-to-float v2, v0
a=0;// 
a=0;//     move-object/from16 v0, p0
a=0;// 
a=0;//     iget v3, v0, Landroid/support/v4/view/ViewPager;->mLastOffset:F
a=0;// 
a=0;//     mul-float v15, v2, v3
a=0;// 
a=0;//     .line 2348
...
a=0;// 
a=0;//     .line 2349
a=0;//     .local v11, "firstItem":Landroid/support/v4/view/ViewPager$ItemInfo;
a=0;//     move-object/from16 v0, p0
a=0;// 
a=0;//     iget-object v2, v0, Landroid/support/v4/view/ViewPager;->mItems:Ljava/util/ArrayList;
a=0;// 
a=0;//     move-object/from16 v0, p0
a=0;// 
a=0;//     iget-object v3, v0, Landroid/support/v4/view/ViewPager;->mItems:Ljava/util/ArrayList;
a=0;// 
...
a=0;// 
a=0;//     check-cast v12, Landroid/support/v4/view/ViewPager$ItemInfo;
a=0;// 
a=0;//     .line 2350
a=0;//     .local v12, "lastItem":Landroid/support/v4/view/ViewPager$ItemInfo;
a=0;//     iget v2, v11, Landroid/support/v4/view/ViewPager$ItemInfo;->position:I
a=0;// 
a=0;//     if-eqz v2, :cond_1
a=0;// 
a=0;//     .line 2351
a=0;//     iget v2, v11, Landroid/support/v4/view/ViewPager$ItemInfo;->offset:F
a=0;// 
a=0;//     move/from16 v0, v17
a=0;// 
...
a=0;//     .line 2353
a=0;//     :cond_1
a=0;//     iget v2, v12, Landroid/support/v4/view/ViewPager$ItemInfo;->position:I
a=0;// 
a=0;//     move-object/from16 v0, p0
a=0;// 
...
a=0;// 
a=0;//     .line 2354
a=0;//     iget v2, v12, Landroid/support/v4/view/ViewPager$ItemInfo;->offset:F
a=0;// 
a=0;//     move/from16 v0, v17
a=0;// 
a=0;//     int-to-float v3, v0
...
a=0;//     .line 2357
a=0;//     :cond_2
a=0;//     cmpg-float v2, v16, v13
a=0;// 
a=0;//     if-gez v2, :cond_4
a=0;// 
a=0;//     .line 2358
a=0;//     move/from16 v16, v13
a=0;// 
a=0;//     .line 2363
a=0;//     :cond_3
a=0;//     :goto_0
...
a=0;//     move-object/from16 v0, p0
a=0;// 
a=0;//     invoke-virtual {v0, v2, v3}, Landroid/support/v4/view/ViewPager;->scrollTo(II)V
a=0;// 
a=0;//     .line 2365
a=0;//     move/from16 v0, v16
a=0;// 
...
a=0;//     move-object/from16 v0, p0
a=0;// 
a=0;//     invoke-direct {v0, v2}, Landroid/support/v4/view/ViewPager;->pageScrolled(I)Z
a=0;// 
a=0;//     .line 2368
a=0;//     invoke-static {}, Landroid/os/SystemClock;->uptimeMillis()J
a=0;// 
...
a=0;//     move-object/from16 v0, p0
a=0;// 
a=0;//     iget-wide v2, v0, Landroid/support/v4/view/ViewPager;->mFakeDragBeginTime:J
a=0;// 
a=0;//     const/4 v6, 0x2
a=0;// 
a=0;//     move-object/from16 v0, p0
a=0;// 
a=0;//     iget v7, v0, Landroid/support/v4/view/ViewPager;->mLastMotionX:F
a=0;// 
a=0;//     const/4 v8, 0x0
a=0;// 
a=0;//     const/4 v9, 0x0
a=0;// 
a=0;//     invoke-static/range {v2 .. v9}, Landroid/view/MotionEvent;->obtain(JJIFFI)Landroid/view/MotionEvent;
a=0;// 
a=0;//     move-result-object v10
a=0;// 
a=0;//     .line 2371
a=0;//     .local v10, "ev":Landroid/view/MotionEvent;
a=0;//     move-object/from16 v0, p0
a=0;// 
a=0;//     iget-object v2, v0, Landroid/support/v4/view/ViewPager;->mVelocityTracker:Landroid/view/VelocityTracker;
a=0;// 
a=0;//     invoke-virtual {v2, v10}, Landroid/view/VelocityTracker;->addMovement(Landroid/view/MotionEvent;)V
a=0;// 
a=0;//     .line 2372
a=0;//     invoke-virtual {v10}, Landroid/view/MotionEvent;->recycle()V
a=0;// 
a=0;//     .line 2373
a=0;//     return-void
a=0;// 
a=0;//     .line 2359
a=0;//     .end local v4    # "time":J
a=0;//     .end local v10    # "ev":Landroid/view/MotionEvent;
a=0;//     :cond_4
a=0;//     cmpl-float v2, v16, v15
a=0;// 
...
a=0;// 
a=0;//     const/high16 v28, 0x40000000    # 2.0f
a=0;// 
