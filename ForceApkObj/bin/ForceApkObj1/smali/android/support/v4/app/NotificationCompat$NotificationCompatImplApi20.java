package android.support.v4.app; class NotificationCompat$NotificationCompatImplApi20 { void a() { int a;
a=0;// .class Landroid/support/v4/app/NotificationCompat$NotificationCompatImplApi20;
a=0;// .super Landroid/support/v4/app/NotificationCompat$NotificationCompatImplKitKat;
...
a=0;//     accessFlags = 0x8
a=0;//     name = "NotificationCompatImplApi20"
a=0;// .end annotation
a=0;// 
a=0;// 
a=0;// # direct methods
...
a=0;//     .prologue
a=0;//     .line 509
a=0;//     invoke-direct {p0}, Landroid/support/v4/app/NotificationCompat$NotificationCompatImplKitKat;-><init>()V
a=0;// 
a=0;//     return-void
a=0;// .end method
a=0;// 
...
a=0;//     .prologue
a=0;//     .line 512
a=0;//     new-instance v1, Landroid/support/v4/app/NotificationCompatApi20$Builder;
a=0;// 
...
a=0;// 
a=0;//     invoke-direct/range {v1 .. v22}, Landroid/support/v4/app/NotificationCompatApi20$Builder;-><init>(Landroid/content/Context;Landroid/app/Notification;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Landroid/widget/RemoteViews;ILandroid/app/PendingIntent;Landroid/app/PendingIntent;Landroid/graphics/Bitmap;IIZZILjava/lang/CharSequence;ZLandroid/os/Bundle;Ljava/lang/String;ZLjava/lang/String;)V
a=0;// 
a=0;//     .line 518
a=0;//     .local v1, "builder":Landroid/support/v4/app/NotificationCompatApi20$Builder;
a=0;//     move-object/from16 v0, p1
a=0;// 
...
a=0;// 
a=0;//     .line 520
a=0;//     invoke-virtual {v1}, Landroid/support/v4/app/NotificationCompatApi20$Builder;->build()Landroid/app/Notification;
a=0;// 
...
a=0;// 
a=0;//     invoke-static {p1, p2, v0, v1}, Landroid/support/v4/app/NotificationCompatApi20;->getAction(Landroid/app/Notification;ILandroid/support/v4/app/NotificationCompatBase$Action$Factory;Landroid/support/v4/app/RemoteInputCompatBase$RemoteInput$Factory;)Landroid/support/v4/app/NotificationCompatBase$Action;
a=0;// 
...
a=0;//     .prologue
a=0;//     .line 549
a=0;//     invoke-static {p1}, Landroid/support/v4/app/NotificationCompatApi20;->getGroup(Landroid/app/Notification;)Ljava/lang/String;
a=0;// 
a=0;//     move-result-object v0
a=0;// 
a=0;//     return-object v0
...
a=0;//     .prologue
a=0;//     .line 544
a=0;//     invoke-static {p1}, Landroid/support/v4/app/NotificationCompatApi20;->getLocalOnly(Landroid/app/Notification;)Z
a=0;// 
a=0;//     move-result v0
a=0;// 
a=0;//     return v0
...
a=0;//     .prologue
a=0;//     .line 539
a=0;//     invoke-static {p1}, Landroid/support/v4/app/NotificationCompatApi20;->getParcelableArrayListForActions([Landroid/support/v4/app/NotificationCompatBase$Action;)Ljava/util/ArrayList;
a=0;// 
a=0;//     move-result-object v0
a=0;// 
a=0;//     return-object v0
...
a=0;//     .prologue
a=0;//     .line 559
a=0;//     invoke-static {p1}, Landroid/support/v4/app/NotificationCompatApi20;->getSortKey(Landroid/app/Notification;)Ljava/lang/String;
a=0;// 
a=0;//     move-result-object v0
a=0;// 
a=0;//     return-object v0
...
a=0;//     .prologue
a=0;//     .line 554
a=0;//     invoke-static {p1}, Landroid/support/v4/app/NotificationCompatApi20;->isGroupSummary(Landroid/app/Notification;)Z
a=0;// 
a=0;//     move-result v0
a=0;// 
a=0;//     return v0
