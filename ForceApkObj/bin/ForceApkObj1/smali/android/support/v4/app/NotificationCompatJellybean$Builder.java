...
a=0;// 
a=0;//     iput-object v4, p0, Landroid/support/v4/app/NotificationCompatJellybean$Builder;->mActionExtrasList:Ljava/util/List;
a=0;// 
a=0;//     .line 77
a=0;//     new-instance v4, Landroid/app/Notification$Builder;
a=0;// 
a=0;//     invoke-direct {v4, p1}, Landroid/app/Notification$Builder;-><init>(Landroid/content/Context;)V
a=0;// 
a=0;//     iget-wide v6, p2, Landroid/app/Notification;->when:J
a=0;// 
a=0;//     invoke-virtual {v4, v6, v7}, Landroid/app/Notification$Builder;->setWhen(J)Landroid/app/Notification$Builder;
a=0;// 
a=0;//     move-result-object v4
a=0;// 
a=0;//     iget v5, p2, Landroid/app/Notification;->icon:I
a=0;// 
a=0;//     iget v6, p2, Landroid/app/Notification;->iconLevel:I
a=0;// 
a=0;//     invoke-virtual {v4, v5, v6}, Landroid/app/Notification$Builder;->setSmallIcon(II)Landroid/app/Notification$Builder;
a=0;// 
a=0;//     move-result-object v4
a=0;// 
a=0;//     iget-object v5, p2, Landroid/app/Notification;->contentView:Landroid/widget/RemoteViews;
a=0;// 
...
a=0;//     move-result-object v4
a=0;// 
a=0;//     iget-object v5, p2, Landroid/app/Notification;->tickerText:Ljava/lang/CharSequence;
a=0;// 
a=0;//     invoke-virtual {v4, v5, p6}, Landroid/app/Notification$Builder;->setTicker(Ljava/lang/CharSequence;Landroid/widget/RemoteViews;)Landroid/app/Notification$Builder;
a=0;// 
a=0;//     move-result-object v4
a=0;// 
a=0;//     iget-object v5, p2, Landroid/app/Notification;->sound:Landroid/net/Uri;
a=0;// 
a=0;//     iget v6, p2, Landroid/app/Notification;->audioStreamType:I
a=0;// 
...
a=0;//     move-result-object v4
a=0;// 
a=0;//     iget-object v5, p2, Landroid/app/Notification;->vibrate:[J
a=0;// 
a=0;//     invoke-virtual {v4, v5}, Landroid/app/Notification$Builder;->setVibrate([J)Landroid/app/Notification$Builder;
a=0;// 
a=0;//     move-result-object v4
a=0;// 
a=0;//     iget v5, p2, Landroid/app/Notification;->ledARGB:I
a=0;// 
a=0;//     iget v6, p2, Landroid/app/Notification;->ledOnMS:I
a=0;// 
a=0;//     iget v7, p2, Landroid/app/Notification;->ledOffMS:I
a=0;// 
a=0;//     invoke-virtual {v4, v5, v6, v7}, Landroid/app/Notification$Builder;->setLights(III)Landroid/app/Notification$Builder;
a=0;// 
a=0;//     move-result-object v5
a=0;// 
a=0;//     iget v4, p2, Landroid/app/Notification;->flags:I
a=0;// 
...
a=0;//     move-result-object v4
a=0;// 
a=0;//     iget v5, p2, Landroid/app/Notification;->defaults:I
a=0;// 
a=0;//     invoke-virtual {v4, v5}, Landroid/app/Notification$Builder;->setDefaults(I)Landroid/app/Notification$Builder;
a=0;// 
a=0;//     move-result-object v4
a=0;// 
a=0;//     invoke-virtual {v4, p3}, Landroid/app/Notification$Builder;->setContentTitle(Ljava/lang/CharSequence;)Landroid/app/Notification$Builder;
a=0;// 
a=0;//     move-result-object v4
a=0;// 
a=0;//     invoke-virtual {v4, p4}, Landroid/app/Notification$Builder;->setContentText(Ljava/lang/CharSequence;)Landroid/app/Notification$Builder;
a=0;// 
a=0;//     move-result-object v4
a=0;// 
a=0;//     move-object/from16 v0, p16
a=0;// 
a=0;//     invoke-virtual {v4, v0}, Landroid/app/Notification$Builder;->setSubText(Ljava/lang/CharSequence;)Landroid/app/Notification$Builder;
a=0;// 
a=0;//     move-result-object v4
a=0;// 
a=0;//     invoke-virtual {v4, p5}, Landroid/app/Notification$Builder;->setContentInfo(Ljava/lang/CharSequence;)Landroid/app/Notification$Builder;
a=0;// 
a=0;//     move-result-object v4
a=0;// 
a=0;//     move-object/from16 v0, p8
a=0;// 
a=0;//     invoke-virtual {v4, v0}, Landroid/app/Notification$Builder;->setContentIntent(Landroid/app/PendingIntent;)Landroid/app/Notification$Builder;
a=0;// 
a=0;//     move-result-object v4
a=0;// 
a=0;//     iget-object v5, p2, Landroid/app/Notification;->deleteIntent:Landroid/app/PendingIntent;
a=0;// 
...
a=0;//     move-result-object v4
a=0;// 
a=0;//     invoke-virtual {v4, p7}, Landroid/app/Notification$Builder;->setNumber(I)Landroid/app/Notification$Builder;
a=0;// 
a=0;//     move-result-object v4
a=0;// 
a=0;//     move/from16 v0, p14
a=0;// 
a=0;//     invoke-virtual {v4, v0}, Landroid/app/Notification$Builder;->setUsesChronometer(Z)Landroid/app/Notification$Builder;
a=0;// 
a=0;//     move-result-object v4
a=0;// 
a=0;//     move/from16 v0, p15
a=0;// 
a=0;//     invoke-virtual {v4, v0}, Landroid/app/Notification$Builder;->setPriority(I)Landroid/app/Notification$Builder;
a=0;// 
a=0;//     move-result-object v4
a=0;// 
...
a=0;//     move-result-object v4
a=0;// 
a=0;//     iput-object v4, p0, Landroid/support/v4/app/NotificationCompatJellybean$Builder;->b:Landroid/app/Notification$Builder;
a=0;// 
a=0;//     .line 102
...
a=0;// 
a=0;//     iput-object v4, p0, Landroid/support/v4/app/NotificationCompatJellybean$Builder;->mExtras:Landroid/os/Bundle;
a=0;// 
a=0;//     .line 103
a=0;//     if-eqz p18, :cond_0
a=0;// 
a=0;//     .line 104
a=0;//     iget-object v4, p0, Landroid/support/v4/app/NotificationCompatJellybean$Builder;->mExtras:Landroid/os/Bundle;
a=0;// 
a=0;//     move-object/from16 v0, p18
a=0;// 
a=0;//     invoke-virtual {v4, v0}, Landroid/os/Bundle;->putAll(Landroid/os/Bundle;)V
a=0;// 
a=0;//     .line 106
a=0;//     :cond_0
...
a=0;//     iget-object v4, p0, Landroid/support/v4/app/NotificationCompatJellybean$Builder;->mExtras:Landroid/os/Bundle;
a=0;// 
a=0;//     const-string v5, "android.support.localOnly"
a=0;// 
a=0;//     const/4 v6, 0x1
a=0;// 
a=0;//     invoke-virtual {v4, v5, v6}, Landroid/os/Bundle;->putBoolean(Ljava/lang/String;Z)V
a=0;// 
a=0;//     .line 109
a=0;//     :cond_1
...
a=0;//     iget-object v4, p0, Landroid/support/v4/app/NotificationCompatJellybean$Builder;->mExtras:Landroid/os/Bundle;
a=0;// 
a=0;//     const-string v5, "android.support.groupKey"
a=0;// 
a=0;//     move-object/from16 v0, p19
a=0;// 
a=0;//     invoke-virtual {v4, v5, v0}, Landroid/os/Bundle;->putString(Ljava/lang/String;Ljava/lang/String;)V
a=0;// 
a=0;//     .line 111
...
a=0;//     iget-object v4, p0, Landroid/support/v4/app/NotificationCompatJellybean$Builder;->mExtras:Landroid/os/Bundle;
a=0;// 
a=0;//     const-string v5, "android.support.isGroupSummary"
a=0;// 
a=0;//     const/4 v6, 0x1
a=0;// 
a=0;//     invoke-virtual {v4, v5, v6}, Landroid/os/Bundle;->putBoolean(Ljava/lang/String;Z)V
...
a=0;//     iget-object v4, p0, Landroid/support/v4/app/NotificationCompatJellybean$Builder;->mExtras:Landroid/os/Bundle;
a=0;// 
a=0;//     const-string v5, "android.support.sortKey"
a=0;// 
...
a=0;//     iget-object v4, p0, Landroid/support/v4/app/NotificationCompatJellybean$Builder;->mExtras:Landroid/os/Bundle;
a=0;// 
a=0;//     const-string v5, "android.support.useSideChannel"
a=0;// 
a=0;//     const/4 v6, 0x1
a=0;// 
a=0;//     invoke-virtual {v4, v5, v6}, Landroid/os/Bundle;->putBoolean(Ljava/lang/String;Z)V
