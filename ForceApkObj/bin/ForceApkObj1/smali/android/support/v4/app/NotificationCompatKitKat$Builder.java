...
a=0;// 
a=0;//     iput-object v4, p0, Landroid/support/v4/app/NotificationCompatKitKat$Builder;->mActionExtrasList:Ljava/util/List;
a=0;// 
a=0;//     .line 44
...
a=0;//     move-result-object v4
a=0;// 
a=0;//     iput-object v4, p0, Landroid/support/v4/app/NotificationCompatKitKat$Builder;->b:Landroid/app/Notification$Builder;
a=0;// 
a=0;//     .line 69
...
a=0;// 
a=0;//     iput-object v4, p0, Landroid/support/v4/app/NotificationCompatKitKat$Builder;->mExtras:Landroid/os/Bundle;
a=0;// 
a=0;//     .line 70
a=0;//     if-eqz p18, :cond_0
a=0;// 
a=0;//     .line 71
a=0;//     iget-object v4, p0, Landroid/support/v4/app/NotificationCompatKitKat$Builder;->mExtras:Landroid/os/Bundle;
a=0;// 
