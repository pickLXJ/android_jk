package android.support.v4.net; class ConnectivityManagerCompatHoneycombMR2 { void a() { int a;
a=0;// .class Landroid/support/v4/net/ConnectivityManagerCompatHoneycombMR2;
a=0;// .super Ljava/lang/Object;
a=0;// .source "ConnectivityManagerCompatHoneycombMR2.java"
a=0;// 
a=0;// 
a=0;// # direct methods
