...
a=0;// 
a=0;//     sub-long v4, v8, v0
a=0;// 
a=0;//     invoke-virtual {p0, v2, v4, v5}, Landroid/support/v4/widget/ContentLoadingProgressBar;->postDelayed(Ljava/lang/Runnable;J)Z
a=0;// 
a=0;//     .line 109
...
a=0;// 
a=0;//     invoke-virtual {p0, v0, v2, v3}, Landroid/support/v4/widget/ContentLoadingProgressBar;->postDelayed(Ljava/lang/Runnable;J)Z
a=0;// 
a=0;//     .line 125
a=0;//     const/4 v0, 0x1
a=0;// 
