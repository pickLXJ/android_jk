package android.support.v4.widget; class SwipeRefreshLayout$5 { void a() { int a;
a=0;// .class Landroid/support/v4/widget/SwipeRefreshLayout$5;
...
a=0;//     .prologue
a=0;//     .line 139
a=0;//     iput-object p1, p0, Landroid/support/v4/widget/SwipeRefreshLayout$5;->this$0:Landroid/support/v4/widget/SwipeRefreshLayout;
a=0;// 
...
a=0;//     .prologue
a=0;//     .line 143
a=0;//     iget-object v0, p0, Landroid/support/v4/widget/SwipeRefreshLayout$5;->this$0:Landroid/support/v4/widget/SwipeRefreshLayout;
a=0;// 
a=0;//     const/4 v1, 0x1
a=0;// 
...
a=0;//     iget-object v0, p0, Landroid/support/v4/widget/SwipeRefreshLayout$5;->this$0:Landroid/support/v4/widget/SwipeRefreshLayout;
a=0;// 
a=0;//     iget-object v1, p0, Landroid/support/v4/widget/SwipeRefreshLayout$5;->this$0:Landroid/support/v4/widget/SwipeRefreshLayout;
a=0;// 
...
a=0;//     move-result v1
a=0;// 
a=0;//     iget-object v2, p0, Landroid/support/v4/widget/SwipeRefreshLayout$5;->this$0:Landroid/support/v4/widget/SwipeRefreshLayout;
a=0;// 
